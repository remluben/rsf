...
/**
 * IHttpStatus provides a collection of HTTP status available.
 *
 * @package interfaces
...
interface IHttpStatus
{
    ...
    /**
     * @deprecated status should not be used any more
     */
    const HTTP_SWITCH_PROXY = '306 Switch Proxy';
    ...
    const HTTP_NETWORK_AUTHENTICATION_REQUIRED = '511 Network Authentication Required';
}